	...
	return (
		<Container>
			...
			<Right>
				<Title>Contact</Title>
				<ContactItem>
					<Room style={{ marginRight: "10px" }} /> Budhanilkanta,Kathmandu
				</ContactItem>
				<ContactItem>
					<Phone style={{ marginRight: "10px" }} /> +9779860080176
				</ContactItem>
				<ContactItem>
					<MailOutline style={{ marginRight: "10px" }} /> prashantnepal143@gmail.com
				</ContactItem>
